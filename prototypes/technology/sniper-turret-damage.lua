...
if data.raw["ammo-turret"]["bob-sniper-turret-2"] then
	table.insert(research_effect, {type = "turret-attack", turret_id = "bob-sniper-turret-2", modifier = 0.40})
end
if data.raw["ammo-turret"]["bob-sniper-turret-3"] then
	table.insert(research_effect, {type = "turret-attack", turret_id = "bob-sniper-turret-3", modifier = 0.40})
end
...
for i=minlevel,maxlevel do
	data:extend({
		createupgrade(i, {
			name_prefix = "bob-sniper-turret-damage-",
